        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="/admin/patient/search" method="get">


                        <div class="form-group row">
                            <label for="inputPassword3" class="col-sm-1 col-form-label">District</label>
                            <div class="col-sm-4">
                            ...
                            {{--<label for="inputPassword3" class="col-sm-1 col-form-label">Result</label>

                            <div class="col-sm-4">
                                <select id="inputState" class="form-control" name="status">
                                    <option>All</option>

                                    <option value="1">অত্যধিক ঝুঁকি</option>
                                    <option value="2">মধ্যম ঝুঁকি</option>
                                    <option value="3">কম ঝুঁকি</option>
