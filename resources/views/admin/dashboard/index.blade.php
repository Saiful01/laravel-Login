        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Medium Risk Patient
                            </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1"> Low Risk Patient
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$little_risk}}</div>
                                </div>
                                <div class="col">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Patient
                            </div>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary text-white" style="color: #ffffff !important;">Today
                        Report</h6>
                    <i class="fas fa-user fa-2x text-gray-300"></i>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="card bg-info text-white shadow col-md-6 mx-auto">
                        <div class="card-body text-center">
                            <div class="text-white ">{{$today_count}}</div>
                            <div class="text-white ">Today Test</div>
                        </div>
                    </div>
                    <div class="card bg-danger text-white shadow col-md-6 mx-auto " style="margin-top: 35px">
                        <div class="card-body text-center">
                            <div class="text-white ">{{$today_low_count}}</div>
                            <div class="text-white ">Today Low Risk</div>
                        </div>
                    </div>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-gradient-info" >
                    <h6 class="m-0 font-weight-bold " style="color: white">Today Gender And Effected List</h6>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card bg-success text-white shadow">
                                <div class="card-body text-center">
                                    <div class="text-white ">{{$today_male_count}}</div>
                                    <div class="text-white ">Today Male Test</div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card bg-primary text-white shadow">
                                <div class="card-body text-center">
                                    <div class="text-white ">{{$today_female_count}}</div>
                                    <div class="text-white ">Today Female Test</div>
                                </div>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <div class="card bg-warning text-white shadow">
                                <div class="card-body text-center">
                                    <div class="text-white ">{{$today_low_count}}</div>
                                    <div class="text-white "> Little Risk </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card bg-secondary text-white shadow">
                                <div class="card-body text-center">
                                    <div class="text-white ">{{$today_medium_count}}</div>
                                    <div class="text-white ">Medium Risk</div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card bg-danger text-white shadow">
                                <div class="card-body text-center">
                                    <div class="text-white ">{{$today_high_count}}</div>
                                    <div class="text-white "> High Risk </div>
                                </div>
                            </div>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-gradient-success">
                    <h6 class="m-0 font-weight-bold text-white">Infected Chart</h6>
                ...
                <!-- Card Body -->
                    ...
                    <span class="mr-2">
                      <i class="fas fa-circle text-primary"></i> Recovered
                            ...
                            <span class="mr-2">
                      <i class="fas fa-circle text-success"></i> Infected
                    </span>
                        </div>
                    </div>
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Reported Cases in Lat 7 days</h6>
                ...
                <div class="card-body">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Patient List In Recent</h6>
                        </div>
                        <div class="card-body">
...
{{--    pai chart 2--}}
    ...
    $count_array = json_encode($count_array);
    ...
    <script>
        ...
        var myLineChart = new Chart(ctx, {
            type: 'line',
            data: {
                labels: [<?php foreach ($histories as $history) {
                    echo "'" . $history->date . "',";
                }?>],
                datasets: [{
                    label: "Tested: ",
                    ...
                    pointHitRadius: 10,
                    pointBorderWidth: 2,
                    data: [<?php foreach ($histories as $history) {
                        echo $history->count . ',';
                    }?>],
                }],
            },
